...
#include <stdio.h>  //program that uses functions to perform the following operations on singly linked list
#include <stdlib.h> //i) creation ii) Insertion iii) Deletion iv)Traversal
